  ...
  return (
    <div className="min-h-screen bg-background font-sans selection:bg-primary/20">
      ...
      <main className="mx-auto max-w-[1200px] px-8 py-24 sm:py-32">
        ...
        {/* Solana Integration (High Impact Card) */}
        <section className="mb-48">
            ...
            <div className="relative z-10 grid gap-16 lg:grid-cols-2 lg:items-center">
              <div>
                ...
                <p className="mb-10 max-w-md text-xl font-medium leading-[1.6] text-[#666]">
                  Connect your wallet to tip creators, fund projects, and earn
                  reputation. Every interaction is fast, real, and verifiable.
                </p>
                <div className="space-y-4">
                  {[
                    "Direct SOL tipping with one click",
              ...
              <div className="flex flex-col gap-4">
                <div className="rounded-[32px] bg-white p-10 shadow-xl shadow-black/[0.03]">
                  ...
                  <p className="text-[44px] font-black tracking-[-1px]">12.45 SOL</p>
                  <p className="text-sm font-medium text-[#666]">Fq3k...x8Yd</p>
                </div>
                <div className="rounded-[32px] bg-white p-10 shadow-xl shadow-black/[0.03]">
                  ...
                  <div className="space-y-6">
                    {["@priya_art", "@rahul_cycles", "@maya_cooks"].map((user, i) => (
                      <div key={user} className="flex items-center justify-between">
                        ...
                        <span className="text-[17px] font-bold text-primary">+{0.1 * (i + 1)} SOL</span>
                      </div>
                    ))}
                  </div>
                </div>
