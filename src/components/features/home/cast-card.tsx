    ...
    <div>
      <div className="flex gap-2.5">
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Reply count (not shown on replies themselves) */}
          {!isReply && (
    ...
    <div className="group relative bg-white rounded-[20px] sm:rounded-[32px] border border-[#f0f0f0] p-4 sm:p-6 shadow-sm transition-all hover:shadow-xl hover:shadow-black/[0.03] overflow-hidden">
      ...
      <div className="flex items-center justify-between mb-3 sm:mb-5">
        <div className="flex items-center gap-2.5 sm:gap-3">
          <div className="h-9 w-9 sm:h-10 sm:w-10 rounded-full bg-muted overflow-hidden relative border border-[#f0f0f0]">
            <Image
      ...
      {/* Integrated Image */}
      {cast.imageUrl && (
        <div className="relative mb-4 sm:mb-6 overflow-hidden rounded-[16px] sm:rounded-[24px] bg-[#f5f5f5] aspect-[4/5]">
          <Image
            src={cast.imageUrl}
            alt={cast.caption}
            fill
